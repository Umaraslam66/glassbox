...
| 2026-07-31 | 4 | Gate 4 baseline 4 (LLM, public profile, NO interview) — 100 held-out personas x 50 held-out probe items x 3 seeded repeats = 15,000 answer-distribution predictions by frozen Qwen3.6-27B at t=0.7, one batched job, one engine init (job 51349316, RUNNING, 1 node x 4 GPUs, boost_qos_dbg) | pending | pending |
